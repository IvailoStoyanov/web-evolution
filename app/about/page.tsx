...
export const metadata: Metadata = {
  ...
  title: 'About us | Web Evolution',
  description: 'Read bout the establishment of Web Evolution and the developer specialist behind it.',
  openGraph: {
    title: 'About us | Web Evolution',
    description: 'Read bout the establishment of Web Evolution and the developer specialist behind it.',
  },
  ...
  return (
    <>
      <IntroHeader
        ...
        paragraph="Web Evolution was esatblished 2021 by Ivaylo Stoyanov. With a Bachelor of Science - BS, Web Development at Manchester Metropolitan University and multiple years of experience in the industry behind his back, Ivaylo decides to branch out and create a digital agency that cares."
      />
      <main id="main">
