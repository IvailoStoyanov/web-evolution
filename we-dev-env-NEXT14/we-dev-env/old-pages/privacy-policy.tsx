export default function FormSuccess() {
  return (
    <div className="centeredContent centeredContent___privacy">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Web Evolution Ltd., Bulgaria, Sofia, Str.
            Liditse 7.
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: i.stoyanov.work@gmail.com</li>
      </ul>
    </div>
  );
}
